      ...
      {clubReportInfo && (
        <div>
          ...
          <Descriptions size="small" column={3} bordered>
            <Descriptions.Item label="社团名称" span={3}>
              {clubReportInfo['club_name']}
            </Descriptions.Item>
            ...
            <Descriptions.Item label="报告介绍" span={3}>
              {clubReportInfo['report_intro']}
            </Descriptions.Item>
            <Descriptions.Item label="代表图" span={3}>
              <Image
                width={250}
                height={150}
                src={clubReportInfo.picture}
            ...
            <Descriptions.Item label="报告内容" span={3}>
              {
                <div
                  dangerouslySetInnerHTML={{
                    __html: clubReportInfo['report_content'],
                  }}
                  style={{
                    margin: '0 35px',
                  }}></div>
