...
function ClubCostList() {
  ...
  // 获取社团费用
  useEffect(() => {
    costStore.getClubCostList(params);
  }, [params]);
  const columns = [
    {
      title: '账单名',
    ...
    <>
      <Table
        ...
        pagination={{
          ...
          defaultPageSize: 5,
          total: costStore.clubCostList.length,
        ...
        dataSource={costStore.clubCostList}
      />
      <Modal
        open={costOpen}
        title="账单信息"
...
export default observer(ClubCostList);
